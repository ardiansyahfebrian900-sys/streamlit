            ...
            if st.button("tambah kategori"):
                if induk_nama and anak_nama:
                    ...
                    if induk_node:
                        ...
                        st.succes(f"berhasil menambahkan '{anak_nama}'di bawah'{induk_node.nama}'!")
            else:
...
with tab3:
            ...
            target_cari = st.text_input("nama kategori yang ingin dicari di jalurnya:")

            if st.button("cari jalur"):
                if target_cari:
                    hasil=root.cari_jalur(target_cari)
                    if hasil:
                        st.success("sitemukan!")
